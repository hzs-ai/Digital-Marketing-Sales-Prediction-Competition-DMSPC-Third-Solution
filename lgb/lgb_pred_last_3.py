...
#                     early_stopping_rounds=early_stopping_rounds,
    ...
    test_df[[ID, target]].to_csv('../res/last_3.csv', index= False)
...
clf = kfold_lightgbm(params,train,feats,target,5,num_boost_round=2000,early_stopping_rounds=2000,categorical_features=categorical_columns)
